...
This page is written to be prescriptive. If you follow it, you should not double-bill, double-invoke tools, or create duplicate work on retries.
...
- Idempotent replays are not double-billed.
