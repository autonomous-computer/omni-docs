...
## Official adapters (private beta)

During private beta, OMNI provides first-party adapters to make MCP integration straightforward.
...
These adapters are currently available to private beta customers. If you do not have access, use the raw HTTP examples above and request adapter access when it becomes available for your account.
