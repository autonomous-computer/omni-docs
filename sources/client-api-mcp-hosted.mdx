...
```text
https://api.turos.app/mcp
```

Compatibility endpoint:

```text
https://api.turos.app/sse
```
...
These adapters are not published to npm/PyPI yet. For internal beta they are distributed as GitHub Release artifacts from the `omni-system` repo, gated by live conformance against `https://api.turos.app/mcp`.
