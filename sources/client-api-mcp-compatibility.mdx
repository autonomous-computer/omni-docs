...
- Primary: `https://api.turos.app/mcp`
- SSE compatibility: `https://api.turos.app/sse`
...
Every SDK release tag (`mcp-sdks-v*`) is gated by live conformance checks against `https://api.turos.app/mcp`:
